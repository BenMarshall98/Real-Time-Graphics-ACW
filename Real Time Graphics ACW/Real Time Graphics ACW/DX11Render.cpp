...
bool Dx11Render::loadRender()
{
	...
	result = mDevice->CreateBlendState(&blendDesc, mBlendState.ReleaseAndGetAddressOf());
	...
	result = mDevice->CreateBlendState(&blendDesc, mNoBlendState.ReleaseAndGetAddressOf());
